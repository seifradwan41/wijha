...
const tourSteps: TourStep[] = [
  {
    ...
    title: "Overview",
    description:
      "Your dashboard home. See your course stats, published content, and pending reviews at a glance.",
  },
  {
    target: '[data-tour="profile"]',
    title: "My Profile",
    description:
      "Set up your public profile. Add your name, bio, teaching style, specialties, and upload photos.",
  },
  {
    target: '[data-tour="courses"]',
    title: "Courses",
    description:
      "Create and manage your courses. Choose category (SAT/ACT/Other), set schedule, price, and target grades.",
  },
  {
    target: '[data-tour="events"]',
    title: "Events & News",
    description:
      "Post events and news for students. Add a photo and WhatsApp link, then submit for admin review.",
  },
  {
    target: '[data-tour="chat"]',
    title: "Chat",
    description:
      "Message the admin team directly. Ask questions or report issues.",
  },
  {
  ...
  return (
    ...
    >
      ...
      <main
        ...
        style={{ marginLeft: 240, flex: 1, padding: "32px 40px" }}
      >
        {children}
      </main>
    </div>
