...
const tourSteps: TourStep[] = [
  {
    ...
    title: "Overview",
    description:
      "Your dashboard home. See your submission stats — pending, approved, and rejected counts.",
  },
  {
    target: '[data-tour="submit"]',
    title: "Submit Content",
    description:
      "Submit courses, events, or news you've found. Fill in the details and send for admin review.",
  },
  {
    target: '[data-tour="submissions"]',
    title: "My Submissions",
    description:
      "Track all your past submissions and see their status. If rejected, you'll see the reason why.",
  },
  {
...
const navItems = [
  ...
  {
    href: "/dashboard/collaborator/submit",
    label: "Submit Content",
    tour: "submit",
  },
  {
    href: "/dashboard/collaborator/submissions",
