...
const adminTourSteps: TourStep[] = [
  {
    ...
    title: "Review Queue",
    description:
      "This is where you approve or reject submissions from community collaborators. Check new content here daily.",
  },
  {
    target: '[data-tour="accounts"]',
    title: "Accounts",
    description:
      "Manage all user accounts. Create new teachers, assistants, or collaborators. Suspend or change passwords here.",
  },
  {
    target: '[data-tour="teacher-manager"]',
    title: "Teacher Manager",
    description:
      "Manage any teacher's courses and events on their behalf. Create, edit, or publish content for them.",
  },
  {
    target: '[data-tour="user-chat"]',
    title: "User Chat",
    description:
      "Chat directly with teachers and collaborators. Respond to their questions and requests.",
  },
  {
  ...
  },
  {
    ...
    title: "Sign Out",
    description: "Click here to securely sign out when you're done.",
  },
];
...
const assistantTourSteps: TourStep[] = [
  {
    ...
    title: "Review Queue",
    description:
      "Review pending submissions from collaborators. Approve good content or reject with a reason.",
  },
  {
    target: '[data-tour="teacher-manager"]',
    title: "Teacher Manager",
    description:
      "Help teachers manage their courses and events. You can create and edit on their behalf.",
  },
  {
    target: '[data-tour="user-chat"]',
    title: "User Chat",
    description: "Chat with teachers and collaborators to support them.",
  },
  {
    target: '[data-tour="chat-admin"]',
    title: "Chat with Admin",
    description:
      "Your direct line to the admin. Ask questions or report issues here.",
  },
  {
    target: '[data-tour="sign-out"]',
    title: "Sign Out",
    description: "Sign out when you're finished.",
  },
];
...
export default function AdminDashboardLayout({
  ...
  const tourTargets: Record<string, string> = {
    ...
    "/dashboard/admin/assistant-chat": isAdmin
      ? "assistant-chat"
      : "chat-admin",
  };
  ...
  return (
    ...
    >
      ...
      <main
        ...
        style={{ marginLeft: 256, flex: 1, padding: "32px 40px" }}
      >
        {children}
      </main>
    </div>
